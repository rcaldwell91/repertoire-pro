...
(function () {
  ...
  function studentChannel() {
    ...
    var h = '<div class="panel" style="margin-bottom:14px;border-left:3px solid var(--gold)">';
    if (!coach) {
