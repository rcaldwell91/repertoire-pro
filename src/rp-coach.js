...
(function () {
  ...
  V10.renderCoach = function () {
    ...
    if (RP.user && RP.profile) {
      ...
      n.innerHTML = 'Got a coach? <b>Sign in</b>, then put their code in at the top of this tab. What they set you appears below it. Your practice is on the Home tab either way, with a coach or without one.';
